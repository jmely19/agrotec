...
function saveUserProfilePhoto(userId, imageBase64) {
    try {
        ...
        alert('Error: The image is too large. Try with a smaller image.');
        return false;
    }
}
...
// Function to create file selection input
...
// Function to update photo in current modal
...
// Function to update avatar in navbar (optional)
function updateNavbarAvatar() {
    // This function can be implemented if you want to show the photo in the navbar too
...
// Enhanced function to show profile with photo
...
// Placeholder function for edit profile
...
// Override original show profile function
